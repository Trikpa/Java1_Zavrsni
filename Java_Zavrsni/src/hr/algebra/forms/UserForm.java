...
import hr.algebra.forms.panels.ActorsAndDirectorsPanel;
import hr.algebra.forms.panels.MoviesPanel;
import hr.algebra.forms.panels.SavePanel;
...
public class UserForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabbedPane.setMinimumSize(new java.awt.Dimension(600, 500));
        tabbedPane.setPreferredSize(new java.awt.Dimension(600, 469));
    ...
    private void init() {
        ...
        tabbedPane.add("Actors and Directors", new ActorsAndDirectorsPanel(moviesPanel));
        tabbedPane.add("Save", new SavePanel(moviesPanel));
    }
}
